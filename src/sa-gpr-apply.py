...
#    run.sagpr0.do_sagpr0(lvals,[lm[0]],fractrain,tens,[kernel[0]],sel,rdm)
    run.sagpr0.do_sagpr0(lvals,lms,fractrain,tens,kernels,sel,rdm,0)
elif (rank==1):
#    run.sagpr1.do_sagpr1(lvals,[lm[1]],fractrain,tens,[kernel[1]],sel,rdm)
    run.sagpr1.do_sagpr1(lvals,lms,fractrain,tens,kernels,sel,rdm,1)
elif (rank==2):
#    run.sagpr2.do_sagpr2(lvals,[lm[0],lm[2]],fractrain,tens,[kernel[0],kernel[2]],sel,rdm)
    run.sagpr2.do_sagpr2(lvals,lms,fractrain,tens,kernels,sel,rdm,2)
elif (rank==3):
#    run.sagpr3.do_sagpr3(lvals,[lm[1],lm[3]],fractrain,tens,[kernel[1],kernel[3]],sel,rdm)
    run.sagpr3.do_sagpr3(lvals,lms,fractrain,tens,kernels,sel,rdm,3)
else:
